...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    JTextField tfstate, tfphone, tfemail, tfcity, tfaddress;
    ...
    UpdateInformation(String meter){
        ...
        JLabel lblmeternumber = new JLabel("Meter Numbers");
        ...
        ImageIcon i1 = new ImageIcon ( ClassLoader.getSystemResource("icon/updateImage11.jpg"));
        Image i2 = i1.getImage().getScaledInstance(400, 400, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel (i3);
        image.setBounds(550,60,400,300);
        add(image);
