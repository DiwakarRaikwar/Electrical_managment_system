...
public class PayBill extends JFrame implements ActionListener{
    ...
    PayBill(String meter){
        ...
        lblname.setBounds ( 35,140,200,30);
        add(lblname);
        ...
        lblmonth.setBounds ( 35,200,200,30);
        add(lblmonth);
        ...
        lblunits.setBounds ( 35,260,200,30);
        add(lblunits);
        ...
        lbltotalbill.setBounds ( 35,320,200,30);
        add(lbltotalbill);
    ...
    public void actionPerformed( ActionEvent ae){
        ...
        if ( ae.getSource() == pay){
            try {
                Conn c = new Conn();
                c.s.executeUpdate("update bill set status ='Paid' where meter_no = '"+meter+"' , month='"+cmonth.getSelectedItem()+"'");
            }catch (Exception e){
                e.printStackTrace();
            }
            setVisible ( false);
